...
def parse_args():
    ...
    parser.add_argument('--assignment',default='closest',help='selecting prototype ')

    parser.add_argument('--OT_mode', type=str, default='uniform', help="Mode for prototype capacity (e.g., uniform, adaptive, etc.)")
    parser.add_argument('--loss_type',type=str,default='regular',help='Loss types')
