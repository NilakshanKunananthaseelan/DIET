...
# ==============================================================================
# Shell Script to Run Semantic LoRA Experiments (Hyp-Busemann)
# ==============================================================================
...
#
# To Run:
# 1. Make the script executable: chmod +x run_semantic.sh
# 2. Execute it: ./run_semantic.sh
# ==============================================================================
...
DATASETS_TO_RUN="OxfordPets"

SHOTS_TO_RUN="16"
SEEDS_TO_RUN="1"
LRS_TO_RUN="0.001"

SAVE_DIR_BASE="${ROOT_PATH}/checkpoints_hyp_lora_${LOSS_TYPE}"
...
echo "Starting Semantic LoRA (Hyp-Busemann) experiments..."
...
echo "=================================================="
echo "All semantic experiments finished."
echo "=================================================="